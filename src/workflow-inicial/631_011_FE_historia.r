...
if (PARAM$lag1) {
  ...
  for (vcol in cols_lagueables)
  {
    ...
    dataset[, paste0(vcol, "_delta1_dif") := get(vcol) + get(paste0(vcol, "_lag1"))]  #Suma columna lag1 y original
...
if (PARAM$lag2) {
  ...
  for (vcol in cols_lagueables)
  {
    ...
    dataset[, paste0(vcol, "_delta2_dif") := get(vcol) + get(paste0(vcol, "_lag2"))]  #Suma columna lag2 y original
...
if (PARAM$lag3) {
  ...
  for (vcol in cols_lagueables)
  {
    ...
    dataset[, paste0(vcol, "_delta3_dif") := get(vcol) + get(paste0(vcol, "_lag3"))]  #Suma columna lag3 y original
