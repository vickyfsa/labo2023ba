...
PARAM <- list()
PARAM$experimento <- "FE631_013"

PARAM$exp_input <- "DR621_000"
...
PARAM$RandomForest$semilla <- 703127 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 821501
...
if (PARAM$lag1) {
  ...
  {
    dataset[, paste0(vcol, "_delta1_dif") := get(vcol) - get(paste0(vcol, "_lag1"))]  #Resta columna lag1 contra original
    dataset[, paste0(vcol, "_delta1_sum") := get(vcol) + get(paste0(vcol, "_lag1"))]  #Suma columna lag1 y original
    #dataset[, paste0(vcol, "_delta1_ln") := log(get(vcol)) - log(get(paste0(vcol, "_lag1")))] #Resta logaritmo natural de columna lag1 al log de la columna original
    dataset[, paste0(vcol, "_delta1_var") := (get(vcol) - get(paste0(vcol, "_lag1"))) / get(paste0(vcol, "_lag1"))] #Crecimiento/Decrecimiento de la variable vs su lag1
    #dataset[, paste0(vcol, "_delta1_weight") := (get(vcol)*2 + get(paste0(vcol, "_lag1"))) / (get(vcol) + get(paste0(vcol, "_lag1")))] #Ratio asignándole más peso a la columna nueva
...
if (PARAM$lag2) {
  ...
  for (vcol in cols_lagueables)
  {
    dataset[, paste0(vcol, "_delta2_dif") := get(vcol) - get(paste0(vcol, "_lag2"))]  #Resta columna lag2 contra original
    dataset[, paste0(vcol, "_delta2_sum") := get(vcol) + get(paste0(vcol, "_lag2"))]  #Suma columna lag2 y original
    #dataset[, paste0(vcol, "_delta2_ln") := log(get(vcol)) - log(get(paste0(vcol, "_lag2")))] #Resta logaritmo natural de columna lag2 al log de la columna original
    dataset[, paste0(vcol, "_delta2_var") := (get(vcol) - get(paste0(vcol, "_lag2"))) / get(paste0(vcol, "_lag2"))] #Crecimiento/Decrecimiento de la variable vs su lag2
    #dataset[, paste0(vcol, "_delta2_weight") := (get(vcol)*2 + get(paste0(vcol, "_lag2"))) / (get(vcol) + get(paste0(vcol, "_lag2")))] #Ratio asignándole más peso a la columna nueva
  }
...
if (PARAM$lag3) {
  ...
  for (vcol in cols_lagueables)
  {
    dataset[, paste0(vcol, "_delta3_dif") := get(vcol) - get(paste0(vcol, "_lag3"))]  #Resta columna lag3 contra original
    dataset[, paste0(vcol, "_delta3_sum") := get(vcol) + get(paste0(vcol, "_lag3"))]  #Suma columna lag3 y original
    #dataset[, paste0(vcol, "_delta3_ln") := log(get(vcol)) - log(get(paste0(vcol, "_lag3")))] #Resta logaritmo natural de columna lag3 al log de la columna original
    dataset[, paste0(vcol, "_delta3_var") := (get(vcol) - get(paste0(vcol, "_lag3"))) / get(paste0(vcol, "_lag3"))] #Crecimiento/Decrecimiento de la variable vs su lag3
    #dataset[, paste0(vcol, "_delta3_weight") := (get(vcol)*2 + get(paste0(vcol, "_lag3"))) / (get(vcol) + get(paste0(vcol, "_lag3")))] #Ratio asignándole más peso a la columna nueva
  }
...
dataset[, paste0(vcol, "_TF3_weight") := (get(vcol)*4 + get(paste0(vcol, "_lag1"))*3 + get(paste0(vcol, "_lag2"))*2 + get(paste0(vcol, "_lag3"))*1) / (get(vcol) + get(paste0(vcol, "_lag1")) + get(paste0(vcol, "_lag2")) + get(paste0(vcol, "_lag3")))] #Ratio asignándole más peso a la columna nueva
dataset[, paste0(vcol, "_TF3_wavg") := (get(vcol)*4 + get(paste0(vcol, "_lag1"))*3 + get(paste0(vcol, "_lag2"))*2 + get(paste0(vcol, "_lag3"))*1) / 4] #Ratio asignándole más peso a la columna nueva
} 

if (PARAM$lag1 & PARAM$lag2)  {
dataset[, paste0(vcol, "_TF2_weight") := (get(vcol)*3 + get(paste0(vcol, "_lag1"))*2 + get(paste0(vcol, "_lag2"))*1 ) / (get(vcol) + get(paste0(vcol, "_lag1")) + get(paste0(vcol, "_lag2")))] #Ratio asignándole más peso a la columna nueva
dataset[, paste0(vcol, "_TF2_wavg") := (get(vcol)*3 + get(paste0(vcol, "_lag1"))*2 + get(paste0(vcol, "_lag2"))*1 ) / 4] #Ratio asignándole más peso a la columna nueva
}
